            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Instant feedback on energy efficiency and environmental impact.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="flex h-15 w-15 items-center justify-center rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection">
                ...
                <div className="w-3/4">
                  ...
                  <p>Works with industry-standard design software you already use.</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="font-medium uppercase text-black dark:text-white">
                Sustainable Design Made Simple
              </h4>
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                Powered by Advanced{" "}
              ...
              <p>
                Our deep neural networks and reinforcement learning algorithms continuously learn and adapt, 
                providing increasingly accurate predictions and optimization recommendations for your designs.
              </p>
              <div>
                <a
                  href="#"
